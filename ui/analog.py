...
class AnalogTab(object):
    ...
    def __init__(self, mwHandle, plotHandle):
        self.plot = plotHandle
        self.mw = mwHandle
        self.curves = {}
        self.data = {}
        self.bars = list()
        ...
        self.plot.setAxisScale(QwtPlot.xBottom, 0, HISTORY)
        self.plot.setAxisScale(QwtPlot.yLeft, 0, 5)
    ...
    def changedUnits(self, index):
        if index is 0:
            ...
            self.plot.setAxisScale(QwtPlot.yLeft, 0, 1024)
            for bar in self.bars:
